  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v2 - Streamlining Your Dining Experience. Reserve your tables and manage reservations with ease, all in one place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v2 - Streamlining Your Dining Experience. Reserve your tables and manage reservations with ease, all in one place.`}
            </Text>
            <Box
